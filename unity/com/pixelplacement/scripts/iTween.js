...
static function moveFrom(obj: GameObject,x: float,y: float,z: float,duration: float,delay: float, easing: String, loop: int){
...
static function fadeFrom(obj: GameObject,endA: float,duration: float,delay: float, easing: String, loop: int){
	if(obj.guiTexture){
...
static function fadeTo(obj: GameObject,endA: float,duration: float,delay: float, easing: String, loop: int){	obj.AddComponent ("iTween");	registers.push(obj);	params.push(new Array(endA,duration,delay,easing,loop,"fadeTo"));}static function rotateTo(obj: GameObject,x: float,y: float,z: float,duration: float,delay: float, easing: String, loop: int){	obj.AddComponent ("iTween");	registers.push(obj);	params.push(new Array(x,y,z,duration,delay,easing,loop,"rotateTo"));}static function rotateBy(obj: GameObject,x: float,y: float,z: float,duration: float,delay: float, easing: String, loop : int){	obj.AddComponent ("iTween");	registers.push(obj);	params.push(new Array(x,y,z,duration,delay,easing,loop,"rotateBy"));}

static function scaleFrom(obj: GameObject,x: float,y: float,z: float,duration: float,delay: float, easing: String, loop : int){
...
static function scaleTo(obj: GameObject,x: float,y: float,z: float,duration: float,delay: float, easing: String, loop : int){	obj.AddComponent ("iTween");	registers.push(obj);	params.push(new Array(x,y,z,duration,delay,easing,loop,"scaleTo"));}

static function colorFrom(obj: GameObject,r: float,g: float,b: float,duration: float,delay: float, easing: String, loop : int){
	if(obj.guiTexture){
...
static function colorTo(obj: GameObject,r: float,g: float,b: float,duration: float,delay: float, easing: String, loop : int){	obj.AddComponent ("iTween");	registers.push(obj);	params.push(new Array(r,g,b,duration,delay,easing,loop,"colorTo"));}
...
private function colorTo(r: float,g: float,b: float,duration: float, delay: float, easing: String, loop:int) {	if(delay > 0){		yield WaitForSeconds (delay);	}	obj = gameObject.transform;	if(obj.guiTexture){		start=obj.guiTexture.color;
